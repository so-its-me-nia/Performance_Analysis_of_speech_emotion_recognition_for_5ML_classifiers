...
def get_best_estimators(classification):
    ...
    """
    if classification:
        return pickle.load(open("C:\\Users\\sunil\\Desktop\\Sem5\\MP_work\\RNN_work\\grid\\best_classifiers.pickle", "rb"))
    else:
        return pickle.load(open("C:\\Users\\sunil\\Desktop\\Sem5\\MP_work\\RNN_work\\grid\\best_regressors.pickle", "rb"))
